...
interface TenantLoginShellProps {
	displayName: string;
	logoUrl: string | null;
	/** URL absoluta al menú público (monolito). Si es null, no se muestra el botón volver. */
	storefrontBackUrl?: string | null;
}
						...
						<>
							<div className="login-aside-brand">
								...
								<p className="login-brand-subtitle">
									Gestión de pedidos, productos, caja y operación diaria.
								</p>
							</div>
