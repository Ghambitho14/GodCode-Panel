 ...
 *
 * Esta misma función existe, byte a byte, en el Portal
 * (`lib/discount/compute-coupon-discount.ts`). Ambas replican la aritmética de la RPC
 ...
 *
 * Si tocas esta función, aplica el mismo cambio en el Portal y actualiza
