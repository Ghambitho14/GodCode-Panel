...
function fmtTooltip(n, currency = 'CLP') {
    try {
 ...
 */
export default function RPTRosenBarChart({ points = [], height = 220, ariaLabel = 'Gráfico de barras', currency = 'CLP' }) {
                    ...
                    {data.map((d) => {
                        ...
                        return (
                            <Button variant="default"
                                ...
                                aria-label={`${d.label}: ${fmtTooltip(d.value, currency)}`}
                            />
                        );
                    })}
                </div>
                ...
                {hovered ? (
                    ...
                    >
                        ...
                        <div className="rpt-rosen-chart__tooltip-row">
                            ...
                            {fmtTooltip(hovered.value, currency)}
                        </div>
                    </div>
                ) : null}
            </div>
