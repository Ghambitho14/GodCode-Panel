...
export function formatPriceSafe(n, currency = 'CLP') {
    try {
...
export function createDashboardChartOptions({ width, height, showRightScale = false, currency = 'CLP' }) {
    const priceFormatter = (n) => formatPriceSafe(n, currency);
    return {
        width,
        height,
        layout: {
