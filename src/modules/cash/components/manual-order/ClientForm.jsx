...
const ClientForm = ({
    ...
    if (openMesaMode) {
        ...
        const isSalonPreset =
            !isDelivery && String(manualOrder.client_name ?? '').trim() === salonDefault;
        ...
        const selectClientePreset = () => {
            const current = String(manualOrder.client_name ?? '').trim();
            updateClientName(current && current !== salonDefault ? current : 'Cliente');
        };
